...
import { QUERY_SELECT_LIMIT } from '../shared/constants/common.constants';

@Injectable()
export class BaseRepository<T extends Document> implements IBaseRepository<T> {
  constructor(private readonly baseModule: Model<T>) {}

  async findAll(params?: IParamQuery<T>): Promise<T[]> {
  ...
  async findOne(params: IParamQuery<T>): Promise<T> {
    params = Object.assign(
      {
        isLean: true,
      },
